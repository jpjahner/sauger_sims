...
## true positives
plot(0, type="n", xlim=c(0,5), ylim=c(0,max(f2s[,4])), xlab="Number of loci", ylab="True assignments", xaxt="n", cex.lab=1.5)
...
## false positives
plot(0, type="n", xlim=c(0,5), ylim=c(0,max(f2s[,5])), xlab="Number of loci", ylab="False assignments", xaxt="n", cex.lab=1.5)
axis(1, at=c(0.5, 1.5, 2.5, 3.5, 4.5), labels=c(100, 500, 1000, 5000, 10000))
